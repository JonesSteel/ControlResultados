...
<html lang="es">
<head>
    <title>Inicio de Sesión - Dirección General del Registro Público del Transporte</title>
    <meta charset="utf-8">
...
<div class="form-wrapper-outer">
    ...
    <form id="formLogin" name="formLogin" method="post" action="<?php echo base_url(); ?>">
        <div class="field-wrapper">
            <input type="text" name="usuario" class="form-data" required autofocus>
            <div class="field-placeholder"><span>Usuario (RFC sin homoclave)</span></div>
        </div>
        <div class="field-wrapper">
            <input type="password" name="password" class="form-data" required>
            <div class="field-placeholder"><span>Introduce tu Contraseña</span></div>
        </div>
        <div class="form-button">
            <a href="<?php echo base_url('Usuarios/agregaUsuario'); ?>" class="form-register">Crear cuenta</a>
